...
const mockResources: Resource[] = [
  ...
  { id: 5, title: '5-Minute Breathing Exercise', type: 'Meditation', language: 'English', description: 'A quick and effective breathing exercise for immediate calm.', imageUrl: 'https://picsum.photos/400/254', imageHint: "woman breathing exercise", link: '#' },
  { id: 6, title: 'Dealing with Peer Pressure', type: 'Video', language: 'Hindi', description: 'Navigating social challenges in college life.', imageUrl: 'https://picsum.photos/400/255', imageHint: "Indian college friends", link: '#' },
];
